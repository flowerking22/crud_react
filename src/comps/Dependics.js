...
export default function Depensics() {
    return (
        <div>
            <ol class="list-group list-group-numbered">
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold">react</div>
                        A JavaScript library for building user interfaces<br />
                        React. js is an open-source JavaScript library that is used for building user interfaces specifically for single-page applications. It's used for handling the view layer for web and mobile apps. React also allows us to create reusable UI components
                    </div>
                    <span class="badge bg-primary rounded-pill">17.0.2</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold">
                            react-dom</div>
                        The react-dom package provides DOM-specific methods that can be used at the top level of your app and as an escape hatch to get outside of the React model </div>
                    <span class="badge bg-primary rounded-pill">17.0.2</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold">react-router-dom</div>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold">font-awesome</div>
                    ...
                    <span class="badge bg-primary rounded-pill">4.0.1</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold">react-router-dom</div>
